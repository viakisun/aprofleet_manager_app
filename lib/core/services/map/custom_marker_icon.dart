...
class CustomMarkerIcon {
  ...
  static Future<BitmapDescriptor> createCartMarkerIcon({
    ...
    final key = cacheKey ?? 'cart_${backgroundColor?.value}_${iconColor?.value}_${size}_$showDirection';
  ...
  static Future<BitmapDescriptor> _createMarkerIcon({
    ...
    _drawCartIcon(canvas, Offset(size/2, size/2), size * 0.6, iconColor, showDirection);
  ...
  static void _drawCartIcon(Canvas canvas, Offset center, double size, Color color, bool showDirection) {
    final paint = Paint()
      ..color = color
  ...
  static void _drawArrow(Canvas canvas, Offset center, double length, Color color) {
    final paint = Paint()
      ..color = color
      ..style = PaintingStyle.fill;
