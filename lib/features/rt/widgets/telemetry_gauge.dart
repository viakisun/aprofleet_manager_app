...
class TelemetryGauge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final angle = percentage * 180.0; // 180 degrees for semi-circle
...
class BatteryGauge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (percentage > 0.5) {
      gaugeColor = DesignTokens.statusActive;
    } else if (percentage > 0.2) {
      gaugeColor = DesignTokens.statusIdle;
    } else {
      gaugeColor = DesignTokens.statusMaintenance;
    }
...
class SpeedMeterPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Green zone (0-60%)
    zonePaint.color = DesignTokens.statusActive;
    canvas.drawArc(
      Rect.fromCircle(center: center, radius: radius - 3),
      math.pi,
      math.pi * 0.6,
    ...
    // Orange zone (60-80%)
    zonePaint.color = DesignTokens.statusIdle;
    canvas.drawArc(
      Rect.fromCircle(center: center, radius: radius - 3),
      math.pi + (math.pi * 0.6),
      math.pi * 0.2,
    ...
    // Red zone (80-100%)
    zonePaint.color = DesignTokens.statusMaintenance;
    canvas.drawArc(
      Rect.fromCircle(center: center, radius: radius - 3),
      math.pi + (math.pi * 0.8),
      math.pi * 0.2,
