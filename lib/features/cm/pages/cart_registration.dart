            ...
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  value: registrationState.manufacturer,
                  decoration: const InputDecoration(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: DropdownButtonFormField<String>(
                  value: registrationState.batteryType,
                  decoration: const InputDecoration(
              ...
              Expanded(
                child: DropdownButtonFormField<int>(
                  value: registrationState.voltage,
                  decoration: const InputDecoration(
                    labelText: 'Voltage',
                    labelStyle: TextStyle(color: Colors.white),
                    border: OutlineInputBorder(),
          ...
          Row(
            children: [
              Expanded(
                child: DropdownButtonFormField<int>(
                  value: registrationState.seating,
                  decoration: const InputDecoration(
                    labelText: 'Seating',
                    labelStyle: TextStyle(color: Colors.white),
                    border: OutlineInputBorder(),
