...
class AlertDetailModal extends StatefulWidget {
  ...
  final VoidCallback? onViewCart; // NEW: Added for compact card redesign
  ...
  const AlertDetailModal({
    ...
    this.onViewCart, // NEW: Optional callback
  });
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Actions (Enhanced with View Cart and Create Work Order)
          Padding(
            padding: const EdgeInsets.all(20),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                // Primary Actions (moved from card)
                if (widget.alert.cartId != null)
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: ViaButton.secondary(
                          ...
                          onPressed: widget.onCreateWorkOrder,
                          icon: Icons.build,
                        ),
                      ),
                    ],
      ...
      child: Column(
        ...
        children: List.generate(4, (index) {
          ...
          return RadioListTile<int>(
            ...
            activeColor: IndustrialDarkTokens.accentPrimary,
          );
        }),
      ),
      footer: Row(
